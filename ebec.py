...
class EBECEncoder(nn.Module):
    def __init__(self, leaky=0.01):
        super(EBECEncoder, self).__init__()
...
class EBECDecoder(nn.Module):
    def __init__(self):
        super(EBECDecoder, self).__init__()
...
class EBEC(nn.Module):
    def __init__(self):
        super(EBEC, self).__init__()
        self.encoder = EBECEncoder()
        self.decoder = EBECDecoder()
